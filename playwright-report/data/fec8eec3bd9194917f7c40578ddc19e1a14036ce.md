...
- Name: testCasesPage.spec.js >> Test Cases Page >> validate each listed test case has a visible title
- Location: tests\testCasesPage.spec.js:22:3

# Error details

```
Error: locator.click: Error: strict mode violation: getByRole('link', { name: 'Test Cases' }) resolved to 2 elements:
    ...
    - generic [ref=e69]:
      ...
      - insertion [ref=e91]:
        - generic [ref=e94]:
          ...
          - link "QA testing services" [ref=e97] [cursor=pointer]
          - link "Development Tools" [ref=e102] [cursor=pointer]
          - link "QA engineer training" [ref=e107] [cursor=pointer]
          - link "Software testing tutorials" [ref=e112] [cursor=pointer]
          - link "Engineers" [ref=e117] [cursor=pointer]
          - link "API testing courses" [ref=e122] [cursor=pointer]
          - link "engineers" [ref=e127] [cursor=pointer]
          - link "API integration services" [ref=e132] [cursor=pointer]
      - generic [ref=e137]:
          ...
          - generic [ref=e325]:
            - generic [ref=e326]:
              ...
              - paragraph [ref=e329]:
                ...
                - link "Internet & Telecom" [ref=e330] [cursor=pointer]
          ...
          - generic [ref=e470]:
            - generic [ref=e471]:
              ...
              - paragraph [ref=e474]:
                ...
                - link "Test case templates" [ref=e475] [cursor=pointer]
          ...
          - generic [ref=e531]:
            - generic [ref=e532]:
              ...
              - paragraph [ref=e535]:
                ...
                - link "Apparel" [ref=e536] [cursor=pointer]
...
```ts
  ...
  4  | 
  5  | test.describe("Test Cases Page", () => {
  6  | 
  7  |   test.beforeEach(async ({ page }) => {
  8  |     await page.goto(BASE_URL);
> 9  |     await page.getByRole("link", { name: "Test Cases" }).click();
     |                                                          ^ Error: locator.click: Error: strict mode violation: getByRole('link', { name: 'Test Cases' }) resolved to 2 elements:
  10 |     await expect(page).toHaveURL(/test_cases/);
  11 |   });
  12 | 
  13 |   test("validate 'Test Cases' heading is visible", async ({ page }) => {
  14 |     await expect(page.getByRole("heading", { name: "Test Cases" })).toBeVisible();
  15 |   });
  16 | 
  17 |   test("validate the test case list is populated", async ({ page }) => {
  18 |     const testCaseItems = page.locator(".panel-group .panel-default");
  19 |     expect(await testCaseItems.count()).toBeGreaterThan(0);
  20 |   });
  21 | 
  22 |   test("validate each listed test case has a visible title", async ({ page }) => {
  23 |     const firstCaseTitle = page.locator(".panel-title").first();
  24 |     await expect(firstCaseTitle).toBeVisible();
  25 |     await expect(firstCaseTitle).not.toBeEmpty();
  26 |   });
  27 | 
  28 | });
  29 | 
